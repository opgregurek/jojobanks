...
import {Box, HStack, Text, VStack, Grid, GridItem, SimpleGrid, Flex, chakra} from "@chakra-ui/react";
...
const HiddenContentComponent = () => {
  ...
  return (
      <FullPageComponent alignItems="center" justifyContent="space-between">
        <VStack>
          {squareContent}
        </VStack>
        <Text fontSize={['40px', '40px', '40px', '81px']}>
          To clarify muddy waters, you must hold them still and let things settle. Designing calls on that same patience.
        </Text>
      </FullPageComponent>
  )
}
...
export default function Home() {
  return (
      <VStack w="100%" gap={[4, 4, 8, 16]}>
            ...
            <VStack width={['auto', 'auto', '400px', '210px']} gap={10} alignItems="flex-start">
              ...
              <VStack gap={3} alignItems="flex-start">
                ...
                <Text fontStyle="italic" color="text.lightGrey">
                  This space is a curated showcase of Josephine&apos;s evolving body of work spanning several years.
                </Text>
                <Text fontStyle="italic" color="text.lightGrey">
        ...
        <FullPageComponent gap={[6, 6, 6, 10]}>
        ...
        <FullPageComponent gap={[6, 6, 6, 10]}>
          <Text fontSize={['32px', '32px', '32px', '40px']} maxW="820px">
            Though time is relative, she has 7 years experience advocating UX/UI in digital solutions. <br /><br />
          ...
          <Text fontSize={['20px', '20px', '20px', '28px']} fontWeight={300} color="text.lightGrey" maxW="820px">
            Facilitating workshops • applying design thinking • conceptualising visual solutions • scoping requirements • building roadmaps.
          </Text>

          <Box>
            <CloudinaryImage cloudinaryImageName="homepage/mushroom-3" alt="" pixelWidth={1440} imageProps={{maxWidth: '100%'}} />
          </Box>
        </FullPageComponent>
      </VStack>
  )
