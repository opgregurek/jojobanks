				...
				<VStack width={['auto', 'auto', '400px', '210px']} gap={10} alignItems="flex-start">
					...
					<VStack gap={3} alignItems="flex-start">
						...
						<Text fontStyle="italic" color="text.lightGrey">
							This space is a curated showcase of Josephine&apos;s evolving body of work spanning several
							years.
						</Text>
						<Text fontStyle="italic" color="text.lightGrey">
							Explore this collection for insights into her creative journey and where she would like to
							go next.
						</Text>
					</VStack>
				</VStack>
