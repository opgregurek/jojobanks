...
const steps: Array<Step> = [
    {
        ...
        description: (
            <>
                Spend time absorbing as much information on the problem as possible before settling on your
                first solution. Focus on the people experiencing the problem and ask yourself how and why.
                Write a list of the questions you have and keep building on it as you learn.<br /><br />
        ...
        activities: [
            ...
            (<>
                ...
                >
                    Talk
                </Link> to people [Everask, Discovery interviews]
            </>),
        ],
    },
    {
        ...
        description: (
            <>
                ...
                then paper to computer. Think about the solution as a living thing that brings joy to those who
                interact with it.
            </>
        ),
        activities: [
    ...
    },
    {
        ...
        activities: [
            'Test it with real people [User testing, Maze]',
            'Tweak it',
            'Create design systems [Figma]',
        ],
    }
]
const ToolkitSteps = () => {
        ...
        <FullScreenStack w="100%" alignItems="flex-start" gap={[16, 16, 24, 64]}>
            ...
            <VStack gap={[8, 8, 16]} w={['100%', '100%', '80%']} marginLeft="auto" marginRight="auto">
                ...
                <SimpleGrid columns={[1, 1, 2, 2]} gap={[8, 8, 16, 16]} alignItems="flex-start">
                    ...
                    <Text fontSize={['16px', '16px', '16px', '22px']}>
                        ...
                        digital solutions that solve it. <br /><br />
            ...
            <VStack w="100%">
                ...
                <HStack gap={[4, 4, 8, 12, 16]}>
                    <Box w={['40px', '40px', '80px', '120px', '160px']} h={['40px', '40px', '80px', '120px', '160px']} bg="background.dark" borderRadius="50%" />
